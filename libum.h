...
public:
     ...
     */
    bool open(const char *broadcastAddress = LIBUM_DEF_BCAST_ADDRESS, const unsigned int timeout = LIBUM_DEF_TIMEOUT)
    {	return (_handle = um_open(broadcastAddress, timeout)) != NULL; }
